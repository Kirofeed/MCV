...
constexpr auto qt_meta_stringdata_CLASSControllerENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "name",
    "handleAddPatientRequest",
    "handleRemovePatientRequest"
);
...
Q_CONSTINIT const QMetaObject Controller::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSControllerENDCLASS_t,
        ...
        // method 'handleAddPatientRequest'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'handleRemovePatientRequest'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>
    >,
    nullptr
...
void Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->handleSearchRequest((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->handleAddPatientRequest(); break;
        case 2: _t->handleRemovePatientRequest((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
